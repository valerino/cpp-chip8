...
/** @brief chip8 intepreter fonts */
static const uint8_t g_chip8_fonts[] = {
...
/** @brief super-chip8 intepreter fonts (digits) */
static const uint8_t g_schip8_fonts[] = {
...
CMemory::CMemory(const char *rom_path)
  ...
  // check image size
  uint32_t interpreter_size = 0x1ff;
  if (game_size > CHIP8_MEMORY_SIZE - interpreter_size) {
  ...
  // check for eti-660 mode (different start address)
  ...
  // copy rom image in the system memory
